...
object OutputterManager
{
    ...
    val outputterA = Outputter(ChannelType.A, conf.pulse.a, conf.webSocket.messageSetting)
    val outputterB = Outputter(ChannelType.B, conf.pulse.b, conf.webSocket.messageSetting)
